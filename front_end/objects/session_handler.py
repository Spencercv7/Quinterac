...
class SessionHandler:
     ...
     def login(self):
          while (not self.logged_in):
               ...
               if (session == 'machine'):
                  #  print('ATM Session Commands:Transfer Funds - transferWithdraw Funds - withdrawDeposit Funds - depositLogout - logout')
                   ...
                   # print('Agent Session Commands:Create Account - createacctDelete Account - deleteacctTransfer Funds - transferWithdraw Funds - withdrawDeposit Funds - depositLogout - logout')
